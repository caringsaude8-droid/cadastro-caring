...
export const routes: Routes = [
  ...
  { path: 'auth', component: LoginComponent, canActivate: [loginGuard] },
  {
    ...
    children: [
      { path: 'home', component: HomeComponent, canActivate: [authGuard], data: { profiles: ['admin'] } },
      { path: 'cadastro-caring', component: CadastroCaringComponent },
      { path: 'cadastro-caring/gestao-cadastro', component: GestaoCadastroComponent, canActivate: [authGuard], data: { profiles: ['admin'] } },
      { path: 'cadastro-caring/gestao-cadastro/consultar-beneficiario', component: ConsultarBeneficiarioComponent, canActivate: [authGuard], data: { profiles: ['admin'] } },
      { path: 'cadastro-caring/gestao-cadastro/usuarios', component: UsuariosComponent, canActivate: [authGuard], data: { profiles: ['admin'] } },
      { path: 'cadastro-caring/gestao-cadastro/aprovacao-cadastro', component: AprovacaoCadastroComponent, canActivate: [authGuard], data: { profiles: ['admin'] } },
      { path: 'cadastro-caring/empresa', component: EmpresasCadastroComponent, canActivate: [authGuard], data: { profiles: ['admin'] } },
      ...
      { path: 'cadastro-caring/beneficiarios/relatorio-beneficiarios', component: RelatorioBeneficiariosComponent, canActivate: [authGuard, empresaGuard], data: { profiles: ['admin', 'gestor'] } },
      { path: 'cadastro-caring/beneficiarios/relatorio-solicitacao', component: RelatorioSolicitacaoComponent, canActivate: [authGuard, empresaGuard], data: { profiles: ['admin', 'gestor'] } },
